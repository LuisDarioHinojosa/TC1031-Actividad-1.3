...
public:
	...
	/*
	 * This is a variation of sequential search. It will search for an element
	 */
	static bool elementExist(std::vector<T>,T value);
...
template <class T>
bool Searcher<T>::elementExist(std::vector<T> vec,T value){
	bool found = false;
